<div class="wrap">
	...
	<h2 style="display: inline-block; vertical-align: middle;margin-left: 25px;">Tweet Button Anywhere<br><small>by <a style="text-decoration:none" href="http://www.eengine.pl" target="_blank">eEngine.pl</a></small></h2>
	<hr>
	...
	<p><b>Notice that links and tags will cause the selected text to be truncated more than usual (tweet can't have more than 145 characters)<br>Enjoy!</b></p>
	<hr>
	<form method="post" action="options.php">
		...
		<table class="form-table">
			...
			<!-- <tr valign="top">
				...
				<th scope="row">Tweet Button CSS</th>

				<td><textarea rows="6" style="min-width: 400px" name="tweetbtn_button_css"><?php // echo get_option('tweetbtn_button_css'); ?></textarea></td>
